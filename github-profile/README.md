...
| **[Calendário Litúrgico Paroquial](https://rodrigodionizio.github.io/calendario-liturgico-paroquial/)** | Calendário com celebrações, santos e leituras do dia, consumido diariamente pela comunidade. Sem framework, otimizado para conexões móveis lentas. | `HTML5` `CSS3` `JavaScript` | 🟢 Produção · [código aberto](https://github.com/rodrigodionizio/calendario-liturgico-paroquial) |
